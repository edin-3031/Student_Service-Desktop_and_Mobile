...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "StudentskiServis.MobileApp.Android.dll" comes first in this list. */
		"StudentskiServis.MobileApp.Android.dll",
		"Flurl.dll",
		"Flurl.Http.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
		...
		"StudentskiServis.MobileApp.dll",
