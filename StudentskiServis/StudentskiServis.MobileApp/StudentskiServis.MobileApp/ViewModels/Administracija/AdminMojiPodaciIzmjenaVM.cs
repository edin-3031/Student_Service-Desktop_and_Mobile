...
{
    public class AdminMojiPodaciIzmjenaVM:BaseViewModel
    {
        private readonly APIService _service = new APIService("Administracija");
        public AdminMojiPodaciIzmjenaVM()
        {

        }

        public AdminMojiPodaciIzmjenaVM(int role, int userId, AdministracijaAdmin t)
        {
            SnimiCommand = new Command(async() =>
            {
                ...
                await _service.Update<AdministracijaAdmin>(userId, t);
